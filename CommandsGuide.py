GUIDE_DICTIONARY = {
    ...
    "View Predictions":
                    {"/view_predictions":
                     ...
                     "/view_server_correct_bold_preds":
                     "View all the correct bold predictions of a server.",
    ...
    "MOD Commands":
                    {"*MODS ONLY*":
                     ...
                     "/rescore_all":
                     "Rescore all finished races. \nThis should be used whenever scoring system is changed",
                     "/force_score_race":
                     "Force scoring of a particular race.",
                     "/force_score_season":
                     "Force scoring of the current season.",
                     "/score_bold_predictions":
